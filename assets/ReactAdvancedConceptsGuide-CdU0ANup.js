import{j as e,B as t,T as r,L as d,a as s}from"./index-CFbW8M46.js";import{C as c,L as n}from"./ListItemText-BI6f-O7I.js";import{T as a,a as l,b as x,c as i,d as o,e as u}from"./TableRow-BxOPkCoK.js";function p(){return e.jsxs(c,{maxWidth:"md",sx:{py:4},children:[e.jsxs(t,{textAlign:"center",mb:3,children:[e.jsx(r,{variant:"h4",component:"h1",fontWeight:"bold",children:"⚙️ Refs, Fragments, Keys и React.memo"}),e.jsx(r,{variant:"subtitle1",color:"textSecondary",mt:1,children:"Продвинутые концепции React"})]}),e.jsxs(t,{className:"refs-section",mt:4,children:[e.jsx(r,{variant:"h6",gutterBottom:!0,fontWeight:"bold",children:"🔍 Refs — ссылки на DOM или значения между рендерами"}),e.jsxs(r,{children:["Используйте ",e.jsx("code",{children:"useRef"}),", чтобы получить доступ к DOM-элементам или сохранить мутабельные данные."]}),e.jsx(t,{component:"pre",sx:{backgroundColor:"#272822",color:"#f8f8f2",padding:2,borderRadius:2,overflowX:"auto"},children:e.jsx("code",{children:`
function TextInput() {
