import{j as e,B as r,T as t,L as n,a as o}from"./index-CFbW8M46.js";import{C as i,L as s}from"./ListItemText-BI6f-O7I.js";function d(){return e.jsxs(i,{maxWidth:"md",sx:{py:4},children:[e.jsxs(r,{textAlign:"center",mb:3,children:[e.jsx(t,{variant:"h4",component:"h1",fontWeight:"bold",children:"📁 Структура проекта на React"}),e.jsx(t,{variant:"subtitle1",color:"textSecondary",mt:1,children:"Как правильно организовать файлы и папки в React-приложении."})]}),e.jsxs(r,{className:"project-description",mt:3,children:[e.jsx(t,{children:"Чтобы начать разрабатывать приложение на React, важно правильно организовать файлы и папки. Ниже приведён пример типичной структуры проекта:"}),e.jsx(r,{component:"pre",sx:{backgroundColor:"#272822",color:"#f8f8f2",padding:2,borderRadius:2,overflowX:"auto",fontSize:"0.9rem"},children:e.jsx("code",{children:`src/
